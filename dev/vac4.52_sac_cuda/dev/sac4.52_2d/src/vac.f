...
verbose=.true. .and.ipe==0     
if(verbose)then
   write(*,'(a)')'VAC 4.52 configured to'
   write(*,'(a)')'  -d=22 -phi=0 -z=0 -g=1976,44 -p=mhd -u=sim1'
   write(*,'(a)')'  -on=cd,rk,mpi'
   write(*,'(a)')'  -off=mc,fct,tvdlf,tvd,impl,poisson,ct,gencoord,resist'
         write(*,'(a,i3,a)')'Running on ',npe,' processors'
endif

if(ipe==0)       time0=cputime()
   ...
   if(residmin>zero .or. residmax<bigdouble)then
      ...
      do iw=1,nw
         wnrm2=sum(w(ixMmin1:ixMmax1,ixMmin2:ixMmax2,iw)**2)
               call mpiallreduce(wnrm2,MPI_SUM)
      ...
      enddo
            call mpiallreduce(residual,MPI_SUM)
...
case('threestep')
 !Shu-s third order method based on eq 2.15b of Yee II with signs corrected 
   ...
   w2(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)=3*quarter*w(ixmin1:ixmax1,&
      ixmin2:ixmax2,1:nw)+quarter*w1(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)
   call advect1(method,dt/4    ,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,&
      idimmax,t+dt  ,w1,t+dt/4,w2)
   w(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)=w(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)/3&
      +w2(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)*(two/3)
...
case('fourstep')
   ...
   call advect1(method,dt/2    ,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,&
      idimmax,t     ,w ,t,w1)
   ! w2=w+Dt/2*k2
   w2(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)=w(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)
   call advect1(method,dt/2    ,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,&
   ...
   w1(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)=(w1(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)&
      +2*w2(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)+w3(ixmin1:ixmax1,ixmin2:ixmax2,&
      1:nw)-4*w(ixmin1:ixmax1,ixmin2:ixmax2,1:nw))/3
   ! w=w+Dt*k4/6
   call advect1(method,dt/6    ,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,&
      idimmax,t+dt  ,w3,t,w)
...
case('sterck')
   ...
   w2(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)=w(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)
   call advect1(method,dt/4   ,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,&
      idimmax,t+dt*0.12,w1,t,w2)
   w1(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)=w(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)
   call advect1(method,dt/2   ,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,&
      idimmax,t+dt/4   ,w2,t,w1)
   call advect1(method,dt     ,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,&
      idimmax,t+dt/2   ,w1,t,w )
...
case('jameson')
   ...
   call advect1(method,dt/4,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,idimmax,&
      t     ,w ,t,w1)
   w2(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)=w(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)
   call advect1(method,dt/3,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,idimmax,t&
      +dt/4,w1,t,w2)
   w1(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)=w(ixmin1:ixmax1,ixmin2:ixmax2,1:nw)
   call advect1(method,dt/2,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,idimmax,t&
      +dt/3,w2,t,w1)
   call advect1(method,dt  ,ixmin1,ixmin2,ixmax1,ixmax2,iws,idimmin,idimmax,t&
      +dt/2,w1,t,w)
...
!!!      dt=min(dt,dtcourant(idim),dtcourant(idim)**2/dtold,1.1*dtold)
      ...
      call mpiallreduce(courantmax,MPI_MAX)
