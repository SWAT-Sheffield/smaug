...
//wd[fencode_MODID(p,i,j,pressuret)]=1.0;
 ...
 wd[fencode_MODID(p,i,j,pressuret)]=  wd[fencode_MODID(p,i,j,pressurek)]+0.5*(wmod[fencode_MODID(p,i,j,b1)]*wmod[fencode_MODID(p,i,j,b1)]+wmod[fencode_MODID(p,i,j,b2)]*wmod[fencode_MODID(p,i,j,b2)])+(wmod[fencode_MODID(p,i,j,b1b)]*wmod[fencode_MODID(p,i,j,b1)]+wmod[fencode_MODID(p,i,j,b2b)]*wmod[fencode_MODID(p,i,j,b2)]);
 ...
 wd[fencode_MODID(p,i,j,ptb)]=  wd[fencode_MODID(p,i,j,pkb)]+0.5*(wmod[fencode_MODID(p,i,j,b1b)]*wmod[fencode_MODID(p,i,j,b1b)]+wmod[fencode_MODID(p,i,j,b2b)]*wmod[fencode_MODID(p,i,j,b2b)]);
