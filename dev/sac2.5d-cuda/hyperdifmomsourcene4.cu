...
/////////////////////////////////////
#include "gradops_hdmne4.cuh"



__global__ void hyperdifmomsourcene4_parallel(struct params *p, real *w, real *wnew, real *wmod, 
...
//dwn1[(NVAR*(p->n[0])*(p->n[1]))+fencode_hdmne4(p,i,j,energy)]=(grad_hdmne4(wtemp,p,i,j,tmp4,ii));
...
/////////////////////////////////////
void checkErrors_hdmne4ne(char *label)
{
...
//__global__ void prop_parallel(struct params *p, real *b, real *w, real *wnew, real *wmod, 
  //  real *dwn1, real *dwn2, real *dwn3, real *dwn4, real *wd)
     ...
     hyperdifmomsourcene4_parallel<<<numBlocks, numThreadsPerBlock>>>(*d_p,*d_w,*d_wnew, *d_wmod, *d_dwn1,  *d_wd, order,ordero,*d_wtemp, field, dim,ii,ii0,dt);
