...
void bc_periodic_MODID(real *wt, struct params *p,int i, int j, int f) {
               ...
               if(i<2 && j<2)
                {
                  if(i==j)
                   // wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,(p->n[0])-2+i,(p->n[1])-2+j,f)];
                   // wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,(p->n[0])-2,(p->n[1])-2,f)];
                ...
                {
                  if(i==(j-(p->n[1])))                  
                    //wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,(p->n[0])-2+i,2+((p->n[1])-j),f)];
                    //wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,(p->n[0])-2,2,f)];
                ...
                {
                  if((i-(p->n[0]))==j)                  
                   // wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,2+((p->n[0])-i),(p->n[1])-2+j,f)];
                    //wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,2,(p->n[1])-2,f)];
                    wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,4-(p->n[0])+i,(p->n[1])-3+j,f)];                                    
                  else                  
                   // wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,2+((p->n[0])-i),(p->n[1])-2+j,f)];
                   // wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,2,(p->n[1])-2,f)];
                   wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,i,(p->n[1])-3+j,f)];                                    
                ...
                else if(i>((p->n[0])-3) && j>((p->n[1])-3))
                {
                  if(i==j)                  
                   // wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,2+((p->n[0])-i),2+((p->n[1])-j),f)];
                    ...
                    wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,4-(p->n[0])+i,4-(p->n[1])+j,f)];                                    
                  else                  
                   // wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,2+((p->n[0])-i),2+((p->n[1])-j),f)]; 
                   // wt[fencode_MODID(p,i,j,f)]=wt[fencode_MODID(p,2,2,f)]; 
