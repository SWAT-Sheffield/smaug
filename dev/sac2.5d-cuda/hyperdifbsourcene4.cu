...
__global__ void hyperdifbsourcene4_parallel(struct params *p, real *w, real *wnew, real *wmod, 
...
/////////////////////////////////////
void checkErrors_hdbne4(char *label)
{
...
//__global__ void prop_parallel(struct params *p, real *b, real *w, real *wnew, real *wmod, 
  //  real *dwn1, real *dwn2, real *dwn3, real *dwn4, real *wd)
     ...
     hyperdifbsourcene4_parallel<<<numBlocks, numThreadsPerBlock>>>(*d_p,*d_w,*d_wnew, *d_wmod, *d_dwn1,  *d_wd, order,ordero,*d_wtemp, field, dim,jj,ii0,mm,sb,dt);
