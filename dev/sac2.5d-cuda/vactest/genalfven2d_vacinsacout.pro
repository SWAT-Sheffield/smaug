...
for j=0,nx(1)-1 do begin
 ...
 iy=x_code(i,j,1)
  ...
  printf,1,i,j,w(i,j,0),w(i,j,1),w(i,j,2),w(i,j,3),w(i,j,4),w(i,j,5),w(i,j,6),w(i,j,7);,format='(i),(X),(i),(X)'
;  printf,1,i,j,w(i,j,0),w(i,j,1),w(i,j,2),w(i,j,3),w(i,j,4),w(i,j,5),w(i,j,6),w(i,j,7),format='(i,x,i,x,f,x,f,x,f,x,f,x,f,x,f,f,x,f)'
