...
npic=128
difmean=dblarr(npic,13)
difmax=dblarr(npic,13)
...
gpuname='3D_tubewave1slow_128_128_128_'
...
for iw=0,nw-1 do begin 
 ...
 difmean(pic,iw)=mean(dwt(*,*,iw))/mean(abs(wt(*,*,iw)))
 difmax(pic,iw)=max(dwt(*,*,iw))/max(abs(wt(*,*,iw)))
...
plot,difmean(*,0),charsize=2.5,title='rho', psym=5, xtitle='iteration/20', ytitle='relative difference'
oplot,difmax(*,0), psym=4

plot,difmean(*,4),charsize=2.5,title='e', psym=5, xtitle='iteration/20', ytitle='relative difference'
...
plot,difmean(*,1),charsize=2.5,title='vz', psym=5, xtitle='iteration/20', ytitle='relative difference'
