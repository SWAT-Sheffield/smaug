...
double precision:: w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw),wnrm2,&
   dtold,time0,time1
...
do
   ...
   if(dtpar>zero)then
      ...
      if(courantpar>zero)call getdt_courant(w,ixMmin1,ixMmin2,ixMmin3,ixMmax1,&
         ixMmax2,ixMmax3)
      call getdt(w,ixMmin1,ixMmin2,ixMmin3,ixMmax1,ixMmax2,ixMmax3)
      call getdt_special(w,ixMmin1,ixMmin2,ixMmin3,ixMmax1,ixMmax2,ixMmax3)
   ...
   wold(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,1:nw)&
      =w(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,1:nw)
   ...
   if(residmin>zero .or. residmax<bigdouble)then
      ...
      residual=zero
      do iw=1,nw
         wnrm2=sum(w(ixMmin1:ixMmax1,ixMmin2:ixMmax2,ixMmin3:ixMmax3,iw)**2)
         
         if(wnrm2<smalldouble)wnrm2=one
         residual = residual + sum((w(ixMmin1:ixMmax1,ixMmin2:ixMmax2,&
            ixMmin3:ixMmax3,iw)-wold(ixMmin1:ixMmax1,ixMmin2:ixMmax2,&
            ixMmin3:ixMmax3,iw))**2)/wnrm2
      enddo
...
double precision:: w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw),&
    w1(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw)
!-----------------------------------------------------------------------------

! Add split sources berforehand if this is required
if(sourcesplit)then
   w1(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,1:nw)&
      =w(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,1:nw)
   select case(typesourcesplit)
      case('sf')
         call addsource2(dt,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
            ixMmin1,ixMmin2,ixMmin3,ixMmax1,ixMmax2,ixMmax3,iws,t,w1,t,w)
      case('sfs')
         call addsource2(dt/2,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
            ixMmin1,ixMmin2,ixMmin3,ixMmax1,ixMmax2,ixMmax3,iws,t,w1,t,w)
      case('ssf')
         call addsource2(dt/2,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
            ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,iws,t,w,t,w1)
         call addsource2(dt,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
            ixMmin1,ixMmin2,ixMmin3,ixMmax1,ixMmax2,ixMmax3,iws,t,w1,t,w)
      case('ssfss')
         call addsource2(dt/4,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
            ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,iws,t,w,t,w1)
         call addsource2(dt/2,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
            ixMmin1,ixMmin2,ixMmin3,ixMmax1,ixMmax2,ixMmax3,iws,t,w1,t,w)
      case default
...
if(typeimpl1=='nul')then
   call advance_expl(typefull1,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,&
      ixGmax3,iws,w1,w)
else
...
if(sourcesplit)then
   ...
   case('sfs')
      w1(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,1:nw)&
         =w(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,1:nw)
      call addsource2(dt/2,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
         ixMmin1,ixMmin2,ixMmin3,ixMmax1,ixMmax2,ixMmax3,iws,t+dt,w1,t+dt,w)
      call getboundary(t+dt,1,nw,1,ndim,w)
   case('ssfss')
      w1(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,1:nw)&
         =w(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,1:nw)
      call addsource2(dt/4,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
         ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,iws,t+dt,w ,t+dt,w1)
      call addsource2(dt/2,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,ixGmax3,&
         ixMmin1,ixMmin2,ixMmin3,ixMmax1,ixMmax2,ixMmax3,iws,t+dt,w1,t+dt, w)
      call getboundary(t+dt,1,nw,1,ndim,w)
   end select
...
!=============================================================================
subroutine advance_expl(method,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
   w1,w)
...
character*10 :: method
integer:: ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws(niw_)
double precision:: w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw),&
   w1(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw)
...
if(ixmin1/=ixGmin1.or.ixmin2/=ixGmin2.or.ixmin3/=ixGmin3.or.ixmax1&
   /=ixGmax1.or.ixmax2/=ixGmax2.or.ixmax3/=ixGmax3)call die&
...
if(dimsplit)then
   if((it/2)*2.eq.it .or. typedimsplit=='xy')then
      ...
      do idimsplit=1,ndim
         ...
         call advect(method,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
            idimsplit,idimsplit,w1,w)
      enddo
   else
   ...
   lastsweep= .true.
   call advect(method,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,1,ndim,w1,&
      w)
endif

if(typefilter1/='nul')then
   ! We use updated w for the filter fluxes
   w1(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
...
if(oktest)write(*,*)'Advance new w:',w(ixtest1,ixtest2,ixtest3,iwtest)

return
end

!=============================================================================
subroutine advect(method,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
   idimmin,idimmax,w1,w) 
...
character*10 :: method
integer:: ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws(niw_),idimmin,idimmax
double precision:: w1(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw),&
   w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw)

! For most Runge-Kutta type schemes one more full array is needed
! For classical RK4 another array is needed
         
double precision:: w2(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw),&
   w3(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw)
...
if(oktest)write(*,*)'Advect method w:',method,' ',w(ixtest1,ixtest2,ixtest3,&
   iwtest)
...
case('onestep')
   call advect1(method,dt,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t,w1,t,w)
...
case('twostep')
   ...
   call advect1(typepred1,dt/2,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t     ,w,t,w1)
   call advect1(method   ,dt  ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/2,w1,t,w)
        
case('threestep')
 !Shu-s third order method based on eq 2.15b of Yee II with signs corrected 
   call advect1(method,dt      ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t     ,w ,t     ,w1)
   w2(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=3*quarter&
      *w(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)+quarter&
      *w1(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)
   call advect1(method,dt/4    ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt  ,w1,t+dt/4,w2)
   w(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)/3+w2(ixmin1:ixmax1,ixmin2:ixmax2,&
      ixmin3:ixmax3,1:nw)*(two/3)
   call advect1(method,dt*two/3,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/2,w2,t+dt/3,w )

        
case('fourstep')
   ! Classical four step Runge-Kutta
   ! w1=w+Dt/2*k1
   call advect1(method,dt/2    ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t     ,w ,t,w1)
   ! w2=w+Dt/2*k2
   w2(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)
   call advect1(method,dt/2    ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/2,w1,t,w2)
   ! w3=w+dt*k3
   w3(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)   
   call advect1(method,dt      ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/2,w2,t,w3)
   ! w1=(w1+2*w2+w3)/3=Dt*(k1+2*k2+2*k3)/6
   w1(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=(w1(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)+2*w2(ixmin1:ixmax1,ixmin2:ixmax2,&
      ixmin3:ixmax3,1:nw)+w3(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)&
      -4*w(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw))/3
   ! w=w+Dt*k4/6
   call advect1(method,dt/6    ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt  ,w3,t,w)
   ! w=w+Dt*(k1+2*k2+2*k3+k4)/6
   w(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)+w1(ixmin1:ixmax1,ixmin2:ixmax2,&
      ixmin3:ixmax3,1:nw)

        
case('sterck')
   ! H. Sterck has this fourstep time integration, w2 is needed
   call advect1(method,dt*0.12,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t        ,w ,t,w1)
   w2(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)
   call advect1(method,dt/4   ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt*0.12,w1,t,w2)
   w1(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)
   call advect1(method,dt/2   ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/4   ,w2,t,w1)
   call advect1(method,dt     ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/2   ,w1,t,w )
...
case('jameson')
   ...
   w2(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)
   call advect1(method,dt/3,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/4,w1,t,w2)
   w1(ixmin1:ixmax1,ixmin2:ixmax2,ixmin3:ixmax3,1:nw)=w(ixmin1:ixmax1,&
      ixmin2:ixmax2,ixmin3:ixmax3,1:nw)
   call advect1(method,dt/2,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/3,w2,t,w1)
   call advect1(method,dt  ,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,iws,&
      idimmin,idimmax,t+dt/2,w1,t,w)
...
if(oktest)write(*,*)'Advect final w:',w(ixtest1,ixtest2,ixtest3,iwtest)
...
!=============================================================================
subroutine advect1(method,qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
   iws,idimmin,idimmax,qtC,wCT,qt,w)
...
integer:: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,ixOmin2,&
   ixOmin3,ixOmax1,ixOmax2,ixOmax3,iws(niw_),idimmin,idimmax,idim
...
if(oktest)write(*,*)'Advect1 istep,wCT,w:',istep,wCT(ixtest1,ixtest2,ixtest3,&
   iwtest),w(ixtest1,ixtest2,ixtest3,iwtest)
...
ixOmin1=ixImin1+2;ixOmin2=ixImin2+2;ixOmin3=ixImin3+2;ixOmax1=ixImax1-2
ixOmax2=ixImax2-2;ixOmax3=ixImax3-2;

select case(method)
        

case('cd4')
   call centdiff4(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
      ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,iws,idimmin,idimmax,qtC,wCT,qt,&
      w)


case('source')
   if(sourceunsplit)call addsource2(qdt,ixImin1,ixImin2,ixImin3,ixImax1,&
      ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,iws,qtC,&
      wCT,qt,w)
case('nul')
...
if(oktest)write(*,*)'Advect1 final w:',w(ixtest1,ixtest2,ixtest3,iwtest)

return
end

!=============================================================================
subroutine addsource2(qdt,ixIImin1,ixIImin2,ixIImin3,ixIImax1,ixIImax2,&
   ixIImax3,ixOOmin1,ixOOmin2,ixOOmin3,ixOOmax1,ixOOmax2,ixOOmax3,iws,qtC,wCT,&
   qt,w)
...
integer:: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,ixOmin2,&
   ixOmin3,ixOmax1,ixOmax2,ixOmax3,ixIImin1,ixIImin2,ixIImin3,ixIImax1,&
   ixIImax2,ixIImax3,ixOOmin1,ixOOmin2,ixOOmin3,ixOOmax1,ixOOmax2,ixOOmax3,&
   iws(niw_)
double precision:: qdt,qtC,qt,wCT(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,&
   nw),w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw)
!-----------------------------------------------------------------------------
...
if(oktest)write(*,*)'Add Source qdt,wCT,w:',qdt,wCT(ixtest1,ixtest2,ixtest3,&
   iwtest),w(ixtest1,ixtest2,ixtest3,iwtest)

! AddSource and SpecialSource may shrink ixO or expand ixI for derivatives 
ixImin1=ixIImin1;ixImin2=ixIImin2;ixImin3=ixIImin3;ixImax1=ixIImax1
ixImax2=ixIImax2;ixImax3=ixIImax3; ixOmin1=ixOOmin1;ixOmin2=ixOOmin2
ixOmin3=ixOOmin3;ixOmax1=ixOOmax1;ixOmax2=ixOOmax2;ixOmax3=ixOOmax3;

call specialsource(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
   ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,iws,qtC,wCT,qt,w)

call     addsource(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
   ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,iws,qtC,wCT,qt,w)

if(oktest)write(*,*)'wnew:',w(ixtest1,ixtest2,ixtest3,iwtest)

! If AddSource/SpecialSource shrunk ixO, getboundary is needed.
if(ixOmin1>ixOOmin1.or.ixOmin2>ixOOmin2.or.ixOmin3>ixOOmin3&
   .or.ixOmax1<ixOOmax1.or.ixOmax2<ixOOmax2.or.ixOmax3<ixOOmax3)then
   call getboundary(qt+qdt,1,nw,1,ndim,w)
   if(oktest)write(*,*)'wnew after getboundary:',w(ixtest1,ixtest2,ixtest3,&
      iwtest)
end if
...
!=============================================================================
subroutine getdt_courant(w,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3)
...
double precision:: w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,nw),&
   cmax(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3),courantmax,dtold
...
!!!      dt=min(dt,dtcourant(idim),dtcourant(idim)**2/dtold,1.1*dtold)
      ...
      call getcmax(new_cmax,w,ixmin1,ixmin2,ixmin3,ixmax1,ixmax2,ixmax3,idim,&
         cmax)
      ...
      if(oktest) write(*,*)'idim,cmax:',idim,cmax(ixtest1,ixtest2,ixtest3)
