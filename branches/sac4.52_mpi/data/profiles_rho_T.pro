...
; 
;openr,1,'/data/ap1vf/3D_256_80_80.ini',/f77_unf
openr,1,'/data/ap1vf/3D_509_36_36_30s.out',/f77_unf

;openr,1,'/data/ap1vf/3D_256_80_80_np010404_014.out',/f77_unf
...
device, filename='rho_T1.eps', /encap
!p.thick = 4
!x.thick = 4
!y.thick = 4
!z.thick = 4
...
AXIS, 4.01d0,alog10(T(4)), YRANGE=[alog10(min(T)), alog10(max(T))], YAXIS=1, $
      /SAVE, charsize=1.5, ytitle=label_T, xtitle=label_Z
