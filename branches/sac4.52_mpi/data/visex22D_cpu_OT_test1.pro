...
;openr,1,'/data/cs1mkg/VAC_NN_tests/zero1.ini',/f77_unf
;openr,1,'/data/cs1mkg/VAC_NN_tests/zero1_BW.ini'
;openr,1,'/data/cs1mkg/VAC_NN_tests/zeroOT.out',/f77_unf
;openr,1,'/data/cs1mkg/VAC_NN_tests/zeroKH.out',/f77_unf
openr,1,'/data/cs1mkg/VAC_NN_tests/zeroOT.out',/f77_unf
;openr,1,'/data/cs1mkg/VAC_NN_tests/zero_sodov.out',/f77_unf
;openr,1,'/data/cs1mkg/VAC_NN_tests/zero_bach.out',/f77_unf
;openr,1,'zeroOT.out',/f77_unf
npic=50
...
;tvframe,w(*,*,0), /bar,title='log rho',/sample, xtitle='x', ytitle='y',charsize=2.0   
...
tvframe,w(*,*,8)+w(*,*,4),/bar,/sample, title='bg_z',  xtitle='x', ytitle='z', charsize=2.0
tvframe,w(*,*,9)+w(*,*,5),/bar,/sample, title='bg_x',  xtitle='x', ytitle='z', charsize=2.0
...
;image_p = TVRD_24()
;write_png,'/data/cs1mkg/VAC_NN_tests/OT/'+indexss+'.png',image_p, red,green, blue
;stop
;endwhile
endfor
