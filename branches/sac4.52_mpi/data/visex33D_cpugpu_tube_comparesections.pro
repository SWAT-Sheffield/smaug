...
window, 0,xsize=900,ysize=400,XPOS = 950, YPOS = 300 
;window, 0,xsize=900,ysize=1200,XPOS = 950, YPOS = 300 
...
wty=dblarr(zend-zstart+1,xend-xstart+1,iw)
...
for iw=0,nw-1 do begin 
 wt(*,*,iw)=reform(w(zstart:zend,ystart:yend,pp,iw))
 wty(*,*,iw)=reform(w(zstart:zend,pp,ystart:yend,iw))
endfor
...
tvframe,rotate(wt(*,*,0),1), /bar,title='rho',$ 
        /sample, xtitle='x', ytitle='y',charsize=1.0
...
tvframe,rotate(wt(*,*,1)/(wt(*,*,0)+wt(*,*,9)),1),/sample, /bar,title='Vz',$
        xtitle='x', ytitle='z',charsize=1.0;, CT='dPdT'


;tvframe,rotate(wty(*,*,1)/(wty(*,*,0)+wty(*,*,9)),1),/sample, /bar,title='Vz',$
...
;plot,difmean(*,0),charsize=2.5,title='rho', psym=5
;oplot,difmax(*,0), psym=4

;plot,difmean(*,4),charsize=2.5,title='e', psym=5
...
;plot,difmean(*,1),charsize=2.5,title='vz', psym=5
