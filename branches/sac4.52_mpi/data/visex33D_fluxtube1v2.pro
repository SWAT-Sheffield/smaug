...
;openr,1,'/fastdata/cs1mkg/smaug/out_tubewave/3D_tubewave1slow_128_128_128_8000.out'
directory='/fastdata/cs1mkg/VAC_NN_tests/'
;directory='/fastdata/cs1mkg/sac_cuda/out_driver_hyp_tube/'

;name='3D_atubet3fast_128_128_128_'
name='3D_atubet1fast_128_128_128_'
;name='3D_tubewave1slow_128_128_128_'
;name='3D_atubetest_128_128_128_'
;name='3D_atubetestslow_128_128_128_'

outfile=directory+'3D_tubewave1_128_128_128_all.out'
...
;openr,1,'/fastdata/cs1mkg/VAC_NN_tests/3D_tube_128_128_128.out',/f77_unf
...
;openr,1,'/data/cs1mkg/sac_cuda/out/3D_tube_128_128_128_90.out'
;openr,1,'/fastdata/cs1mkg/sac_cuda/out_nodriver_nohyp/3D_tube_128_128_128_70.out'
;openr,1,'/fastdata/cs1mkg/sac_cuda/out_ndriver_nohyp_npgft/3D_tube_128_128_128_95.out'
;openr,1,'/fastdata/cs1mkg/sac_cuda/out_driver_hyp_tube/3D_atube_128_128_128_300.out'
;openr,1,outfile
;;;;while not(eof(1)) do begin
  finishfilmloop=0
if (ipic eq 1) then begin
  finishfilmloop=0
endif
...
for filmloop=0,finishfilmloop do begin
...
write_png,'images/alltestfast'+indexss+'.png',image_p, red,green, blue
;goto, jump10
wset,1
!p.multi = [0,2,2,0,1]
...
;dr='/data/ap1vf/3D/torsional_driver/png/'
;vz_slice=dr+'/slice/h_70/'
vz_slice='vz_slice'
...
device, filename='beta.eps', /ENCAPSULATED , $
        xsize=2.5d0*xs, ysize=k*xs
...
CONTOUR, aa(20:80, 0:160),yy(20:80)/scale,zz(0:160)/scale, LEVELS = [1.d0, 10.d0, 15.0] , C_ANNOTATION = ['1.0', '0.1', '0.065'],$ 
         xtitle='x [Mm]', ytitle='z[Mm]',charsize=2.0,$
	 xstyle=1, ystyle=1 
	  ;, $

oplot,yyy/scale, zzz1/scale, linestyle=2 
oplot,yyy/scale, zzz2/scale, linestyle=2 
oplot,yyy/scale, zzz3/scale, linestyle=2 

 xyouts, 14000,3000, 'a', /device
 xyouts, 14000,5500, 'b', /device
 xyouts, 14000,8500, 'c', /device

device, /close
set_plot, 'x'


;CONTOUR, aa, LEVELS = [1.d0, 10.d0, 15.0] , C_ANNOTATION = ['1.0', '0.1', '0.065']  



;plot, alog10(1.d0/beta[*,kk,pp]),title='1/beta',xtitle='x', ytitle='z',charsize=1.4
...
image_p = TVRD_24()
write_png,'images/zoomtestfast'+indexss+'.png',image_p, red,green, blue
endfor
end
